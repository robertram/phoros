...
export const MarketplaceNFT = ({ id, active, collectionAddress, marketplaceAddress, nft, link, onClick }: Props) => {
  const address = useAddress();
  const { contract: marketplace, isLoading: loadingMarketplace } = useContract(marketplaceAddress, 'marketplace-v3')
